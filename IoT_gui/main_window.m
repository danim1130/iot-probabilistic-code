...
%
%      MAIN_WINDOW('Property','Value',...) creates a new MAIN_WINDOW or raises thehttps://www.loom.com/share/c6305b90764e4e428c935e13cc16984c
...
% Last Modified by GUIDE v2.5 10-Mar-2020 16:43:24
...
if (k_value == 0)
    ...
    set(handles.khop, 'string', mat2str(results(3, :)));
else
